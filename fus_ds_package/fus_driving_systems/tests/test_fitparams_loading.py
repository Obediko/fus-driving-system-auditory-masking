...
# Sanity check: with 7 transducers x 2 multi-piece files each (equalization
# + focus), we expect 14 multi-piece files. Adjust this number if the
# transducer count changes, so a silently-missing file gets caught here
# instead of just quietly not being tested.
EXPECTED_MULTI_PIECE_COUNT = 14
